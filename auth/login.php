...
<head>
    ...
    <title>Connexion - AutoShare</title>
...
<body>
    <div class="auth-page">
        <div class="auth-left">
            ...
            <h2>Bienvenue !</h2>
            <p>Connectez-vous à votre compte pour continuer votre expérience d'AutoShare.</p>
            <div class="mt-4">
                <img src="../assets/images/logo_de_page/connexion.jfif" alt="Login Image" style="width: 90%; opacity: 1;">
            </div>
        </div>
