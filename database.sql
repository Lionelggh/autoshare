-- =====================================================
-- AutoShare - Base de données complète
-- Application d'AutoShare
-- =====================================================

-- Sur InfinityFree, la base est créée depuis le panneau (avec préfixe ex: epiz_XXXXXXX_autopartage).
-- Ces deux lignes sont désactivées : importez ce fichier directement dans votre base existante.
...
('Tesla', 'Model 3', 2023, 'Électrique', 'Automatique', 5, 'tesla_model_3.jfif', 4500, 25000, 'La Tesla Model 3 est une berline électrique haute performance offrant une autonomie exceptionnelle et une technologie de pointe. Son intérieur minimaliste et son écran tactile central en font une voiture du futur.', 'Autonomie 580km, Écran tactile 15 pouces, Autopilot, Coffre 425L, Supercharge compatible', 'disponible'),
('BMW', 'X5', 2022, 'Diesel', 'Automatique', 5, 'cars_bmw_x5.jfif', 5500, 35000, 'Le BMW X5 est un SUV premium alliant luxe, confort et performances. Avec son moteur diesel puissant et son intérieur cuir premium, il offre une expérience de conduite inégalée.', 'Intérieur cuir premium, Système de navigation, Caméra de recul, Bluetooth / USB, Toit panoramique', 'disponible'),
('Peugeot', '3008', 2023, 'Essence', 'Automatique', 5, 'image_voiture.jfif', 3500, 20000, 'Le Peugeot 3008 est un SUV compact au design audacieux. Son i-Cockpit innovant et ses équipements technologiques en font un choix idéal pour la ville comme pour les longs trajets.', 'i-Cockpit, Aide au stationnement, Régulateur adaptatif, Écran tactile 10 pouces, GPS intégré', 'disponible'),
('Renault', 'Clio', 2023, 'Essence', 'Manuelle', 5, 'renault_clio.jfif', 2200, 15000, 'La Renault Clio est la citadine par excellence. Compacte, économique et agréable à conduire, elle est parfaite pour les déplacements urbains quotidiens.', 'Écran multimédia 9.3 pouces, Climatisation auto, Aide au parking, Régulateur de vitesse, Apple CarPlay', 'disponible'),
('Audi', 'A4', 2022, 'Diesel', 'Automatique', 5, 'bmw_m850_2020.jfif', 4800, 30000, 'L''Audi A4 incarne l''élégance allemande. Avec ses finitions haut de gamme et sa technologie Quattro disponible, elle offre une conduite raffinée et sportive.', 'Virtual Cockpit, MMI Navigation, Sièges chauffants, Bang & Olufsen, Matrix LED', 'disponible'),
('Mercedes', 'C300', 2023, 'Essence', 'Automatique', 5, 'image_voiture.jfif', 5000, 32000, 'La Mercedes C300 est une berline de luxe qui allie performances et confort. Son intérieur sophistiqué et ses technologies MBUX en font une référence dans sa catégorie.', 'MBUX, Burmester Audio, Conduite semi-autonome, Ambient lighting, Sièges ventilés', 'disponible'),
('Toyota', 'Corolla', 2023, 'Hybride', 'Automatique', 5, 'image_voiture.jfif', 3000, 18000, 'La Toyota Corolla hybride combine efficacité énergétique et fiabilité légendaire. Son système hybride auto-rechargeable offre une consommation remarquablement basse.', 'Hybride auto-rechargeable, Toyota Safety Sense, Écran 8 pouces, Caméra 360°, Régulateur adaptatif', 'disponible'),
('Volkswagen', 'Golf', 2022, 'Essence', 'Manuelle', 5, 'image_voiture.jfif', 3200, 19000, 'La Volkswagen Golf est une compacte iconique reconnue pour sa qualité de fabrication et son agrément de conduite. Un choix sûr et polyvalent.', 'Digital Cockpit, App-Connect, ACC, Lane Assist, Kessy', 'disponible');
...
(2, 'Bienvenue sur AutoShare', 'Bienvenue Jean ! Votre compte a été créé avec succès. Découvrez nos véhicules disponibles.', 'success'),
(2, 'Réservation confirmée', 'Votre réservation du BMW X5 du 25/09 au 27/09 a été confirmée.', 'success'),
(3, 'Bienvenue sur AutoShare', 'Bienvenue Marie ! Votre compte a été créé avec succès.', 'success');
